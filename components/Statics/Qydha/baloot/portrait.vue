<template>
  <div class=" aspect-[9/16] mt-[55px]  flex  justify-center " >
    <!--header   -->
    <div  id="dataHolder"  class=" flex flex-col gap-2   rounded-[25px] pb-[30px] overflow-hidden  w-[90%]  bg-gradient-to-b   from-zinc-700/55  to-zinc-600/55  mx-auto  my-auto ">
      <div class= " relative  h-[36px]  flex justify-center   items-center   ">
        ...
        style="user-select: none; white-space: nowrap; letter-spacing: -0.5px; word-spacing: -1px;"  > {{themName}} </p>
        ...
        style="user-select: none; white-space: nowrap; letter-spacing: -0.5px; word-spacing: -1px;" > {{usName}} </p>
      </div>
...
const { themName,usName,statusUs,statusThem ,BoardStyles} = storeToRefs(store)
