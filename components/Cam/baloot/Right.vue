<template>
  <div class="flex h-[1080px] w-[1920px] flex-col justify-between overflow-visible">
    <div class="flex items-center justify-between overflow-visible">
      <CamPlayerSlot :side="topLeftCam" :image-url="left?.url" />
      <CamPlayerSlot :side="topRightCam" :image-url="top?.url" />
    </div>
    <div class="flex items-center justify-between overflow-visible">
      <CamPlayerSlot :side="bottomLeftCam" :image-url="bottom?.url" />
      <CamPlayerSlot :side="bottomRightCam" :image-url="right?.url" />
    </div>
  </div>
</template>
