<template>
  <div class="flex h-[1080px] w-[1920px] flex-col justify-between overflow-visible">
    <div class="flex items-center justify-between overflow-visible">
      <CamPlayerSlot :side="topLeftCam" :image-url="right?.imageUrl" />
      <CamPlayerSlot :side="topRightCam" :image-url="bottom?.imageUrl" />
    </div>
    <div class="flex items-center justify-between overflow-visible">
      <CamPlayerSlot :side="bottomLeftCam" :image-url="top?.imageUrl" />
      <CamPlayerSlot :side="bottomRightCam" :image-url="left?.imageUrl" />
    </div>
  </div>
</template>
