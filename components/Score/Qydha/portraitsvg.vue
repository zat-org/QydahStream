<template>
  ...
  <div class="flex justify-center  aspect-[9/19.5] relative  mx-auto ">
    ...
    <transition name="fade" mode="out-in">
      <div class=" absolute  bottom-[50px]  w-[80px] h-[80px] origin-center " :key="bottom.url" style="left:calc(50% - 45px)"
