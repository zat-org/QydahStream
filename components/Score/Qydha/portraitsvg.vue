<template>
  ...
  <div class="flex justify-center  aspect-[9/16] mt-5 w-[95%] relative  mx-auto ">
    ...
    <transition name="fade" mode="out-in">
      <div class=" absolute bottom-0 w-[80px] h-[80px] origin-center " :key="bottom.url" style="left:calc(50% - 40px)"
