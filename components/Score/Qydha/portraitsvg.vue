<template>
  ...
  <div class="flex justify-center w-full h-screen relative  ">
    ...
    <div class="absolute  left-0 origin-center   " :style="{ 'top' : 'calc(50% - 50px)' , }" v-if="left && left.url && showPlayers" >
      ...
      <img class=" absolute z-[10] bg-center bg-cover   w-[95px] h-[95px] " :style="{'background-image': `url(${left.url}) ` }"   />
      <img class=" absolute z-[10]  rotate-180 w-[85px] h-[85px]" src='/images/right-square.svg' />
