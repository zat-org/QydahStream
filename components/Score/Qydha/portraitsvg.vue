<template>
  ...
  <div class="flex justify-center w-full h-screen relative  ">
    ...
    <div class="absolute  left-0   w-[95px] h-[95px]    " :style="{ 'top' : 'calc(50% - 50px)' , }" v-if="left && left.url && showPlayers" >
      ...
      <img class=" absolute z-[10] bg-center bg-cover top-[50%] left[50%]   w-[90%] h-[90%] " :style="{'background-image': `url(${left.url}) ` }"   />
      <img class=" absolute z-[10]  rotate-180 w-full h-full top-[50%] left-[50%] " src='/images/right-square.svg' />
